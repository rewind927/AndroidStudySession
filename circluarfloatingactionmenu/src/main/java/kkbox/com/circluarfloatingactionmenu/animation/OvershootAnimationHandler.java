 ...
 */
package kkbox.com.circluarfloatingactionmenu.animation;
 ...
 */
public class OvershootAnimationHandler extends MenuAnimationHandler {
    ...
    public OvershootAnimationHandler() {
        setAnimating(false);
    }
    ...
    public void animateMenuOpening(Point center) {
        ...
        for (int i = 0; i < menu.getSubActionItems().size(); i++) {
            ...
            PropertyValuesHolder pvhY = PropertyValuesHolder.ofFloat(View.TRANSLATION_Y, menu.getSubActionItems().get(i).y - center.y +
