...
public class NumberProgressBar extends View {
    ...
    private static final String INSTANCE_REACHED_BAR_BACKGROUND = "reached_bar_background";
    private static final String INSTANCE_REACHED_BAR_BACKGROUND_COLOR = "reached_bar_color";
    private static final String INSTANCE_UNREACHED_BAR_HEIGHT = "unreached_bar_height";
    private static final String INSTANCE_UNREACHED_BAR_BACKGROUND = "unreached_bar_background";
    private static final String INSTANCE_UNREACHED_BAR_BACKGROUND_COLOR = "unreached_bar_color";
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        // Must call setMeasuredDimension or throws IllegalStateException.
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        bundle.putInt(INSTANCE_REACHED_BAR_BACKGROUND, getmReachedBarBackground());
        bundle.putInt(INSTANCE_REACHED_BAR_BACKGROUND_COLOR, getmReachedBarBackgroundColor());
        bundle.putInt(INSTANCE_UNREACHED_BAR_BACKGROUND, getmUnreachedBarBackground());
        bundle.putInt(INSTANCE_UNREACHED_BAR_BACKGROUND_COLOR, getmUnreachedBarBackgroundColor());
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            mReachedBarBackgroundResId = bundle.getInt(INSTANCE_REACHED_BAR_BACKGROUND);
            mReachedBarBackgroundColor = bundle.getInt(INSTANCE_REACHED_BAR_BACKGROUND_COLOR);
            mUnreachedBarBackgroundResId = bundle.getInt(INSTANCE_UNREACHED_BAR_BACKGROUND);
            mUnreachedBarBackgroundColor = bundle.getInt(INSTANCE_UNREACHED_BAR_BACKGROUND_COLOR);
            initializePainters();
