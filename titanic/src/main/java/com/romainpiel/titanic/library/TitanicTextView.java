...
public class TitanicTextView extends TextView {
	...
	public class DrawableStyle {
		final static public int WAVE = 0;
		final static public int PRACTICE = 1;
	}
	...
	public void createShader() {
		switch (style) {
			case DrawableStyle.PRACTICE:
				createPracticeShader();
				break;
				default:
					createWaveShader();
		}
	...
	/**
	 * Create the blue red horizon shader
	 * draw bitmap with current color for a background
	 * repeat the bitmap horizontally, and clamp colors vertically
	 */
	private void createPracticeShader() {
		int size = 100;
