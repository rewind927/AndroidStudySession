package com.afollestad.dragselectrecyclerview.example;
...
public class MainAdapter extends DragSelectRecyclerViewAdapter<MainAdapter.MainViewHolder>
    ...
    public void onBindViewHolder(MainViewHolder holder, int position) {
        ...
        if (isIndexSelected(position)) {
            d = new ColorDrawable(c.getResources().getColor(R.color.grid_foreground_selected));
            holder.label.setTextColor(c.getResources().getColor(R.color.grid_label_text_selected));
        } else {
            d = null;
	        holder.label.setTextColor(c.getResources().getColor(R.color.grid_label_text_normal));
        }
    ...
    public class MainViewHolder extends RecyclerView.ViewHolder {
        ...
        public final FrameLayout colorSquare;

        public MainViewHolder(View itemView) {
            super(itemView);
            this.label = (TextView) itemView.findViewById(R.id.label);
            this.colorSquare = (FrameLayout) itemView.findViewById(R.id.colorSquare);
        }
    }
}