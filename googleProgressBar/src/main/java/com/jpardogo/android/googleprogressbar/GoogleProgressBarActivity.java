...
import com.jpardogo.android.googleprogressbar.practice.CustomCirclesDrawable;

public class GoogleProgressBarActivity extends ActionBarActivity {
    ...
    private static final int CUSTOM_CIRCLES = 4;
...
//    @InjectView(R.id.progress)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_google_progress);
    ...
    private Drawable getProgressDrawable() {
        ...
        switch (value) {
            ...
            case CHROME_FLOATING_CIRCLES:
                ...
                break;
            case CUSTOM_CIRCLES:
                progressDrawable = new CustomCirclesDrawable.Builder(this)
                        .colors(getProgressDrawableColors())
                        .build();
                break;
        }
