...
public class FloatingActionButton extends ImageButton {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int size = getDimension(
                mType == TYPE.TYPE_NORMAL ? R.dimen.fab_size_normal : R.dimen.fab_size_mini);
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        if (attr != null) {
            try {
                ...
                mType = attr.getInt(R.styleable.FloatingActionButton_fab_type, 0) == 0 ? TYPE.TYPE_NORMAL : TYPE.TYPE_MINI;
            } finally {
                attr.recycle();
            }
        }
    ...
    private Drawable createDrawable(int color) {
        ...
        if (mShadow && !hasLollipopApi()) {
            Drawable shadowDrawable = getResources().getDrawable(mType == TYPE.TYPE_NORMAL ? R.drawable.fab_shadow
        ...
        if (hasLollipopApi()) {
            ...
            setOutlineProvider(new ViewOutlineProvider() {
                ...
                public void getOutline(View view, Outline outline) {
                    int size = getDimension(mType == TYPE.TYPE_NORMAL ? R.dimen.fab_size_normal
